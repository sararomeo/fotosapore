<form action="#" method="POST" name="login-form">
    ...
    <div class="mb-4 mt-4">
        ...
        <div class="form-outline p-2">
            <label hidden for="password">Password</label><input type="password" class="form-control" name="password"
    ...
    <div class="d-flex justify-content-end">
        <input class="form-btn align-right p-2 m-2 rounded" type="button" name="signup-button" value="Sign up"
            onClick="location.href='signup.php'"></input>
