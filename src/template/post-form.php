    ...
    <div class="row p-4">
        ...
        <div class="col-md-7">
            ...
            <div class="form-outline mt-3">
                <label for="imgarticle" hidden>Upload image</label><input type="file"
                    class="btn form-btn align-right p-2 rounded" name="imgarticle" id="imgarticle"
        ...
        <div class="col-md-5">
            ...
            <div class="form-outline p-2">
                <label for="title">Name of the recipe:</label><input type="text" class="form-control" id="title"
                    name="title" required value="<?php
            ...
            <div class="form-outline p-2">
                ...
                <textarea id="caption" class="form-control " name="caption" required rows="3"><?php
            ...
            <div class="form-outline p-2">
                <label for="tags">Tags:</label><textarea id="tags" class="form-control" name="tags" required rows="2"><?php
