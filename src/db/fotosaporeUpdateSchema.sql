...
--
-- Host: 127.0.0.1
-- Creato il: Gen 22, 2023 alle 18:35
...
(1, 'test@mail.it', 'test', 'testpw', 'testbio'),
(2, 'friffio@gmail.com', 'friffio', 'friffio', ''),
(3, 'monta@mail.com', 'monta', '$2y$10$fO7bvN1dZhnVyZUizyQcWOOCHos2nQWpzr/1Gv.3W5ShhNOtzgRIa', '');
...
--
ALTER TABLE `post`
  ADD CONSTRAINT `post_ibfk_2` FOREIGN KEY (`postID`) REFERENCES `postcategory` (`postID`) ON DELETE CASCADE ON UPDATE CASCADE,
